...
g.append(  num.render('',False,'Blue').convert())
g.append(  pygame.image.load('img/a (1).png').convert())
g.append(  pygame.image.load('img/a (2).png').convert())
g.append(  pygame.image.load('img/a (3).png').convert())
g.append(  pygame.image.load('img/a (4).png').convert())
g.append(  pygame.image.load('img/a (5).png').convert())
g.append(  pygame.image.load('img/a (6).png').convert())
g.append(  pygame.image.load('img/a (7).png').convert())
g.append(  pygame.image.load('img/a (8).png').convert())
g.append(  pygame.image.load('img/a (9).png').convert())
